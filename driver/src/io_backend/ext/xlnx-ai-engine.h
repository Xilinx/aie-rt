 ...
 * @loc : location of aie core tiles for which kernel utilization will be
 *	  captured.
 * @perf_util : kernel utilization of the aie core tiles.
 */
...
#define AIE_UPDATE_SHIMDMA_DMABUF_BD_ADDR_IOCTL	_IOW(AIE_IOCTL_BASE, 0x1e, \
						     struct aie_dmabuf_bd_args)
#define AIE_BLOCK_WRITE64_IOCTL		_IOW(AIE_IOCTL_BASE, 0x20, \
					     struct aie_block_write64)
