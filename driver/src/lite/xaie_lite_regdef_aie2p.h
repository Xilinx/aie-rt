...
#define XAIE_SHIM_DMA_MM2S_CHANNEL_CTRL_REGOFF          XAIE2PGBL_NOC_MODULE_DMA_S2MM_0_CTRL
#define XAIE_SHIM_DMA_CHANNEL_CTRL_IDX                  0x8
#define XAIE_SHIM_DMA_CHANNEL_CTRL_IDX_OFFSET           0x10
#define XAIE_SHIM_DMA_CHANNEL_CTRL_PAUSE_MEM_MASK       XAIE2PGBL_NOC_MODULE_DMA_S2MM_0_CTRL_PAUSE_MEM_MASK
...
#define XAIE_AIE_TILE_CORE_LL_REGOFF			XAIE2PGBL_CORE_MODULE_CORE_BMLL0_PART1
#define XAIE_AIE_TILE_CORE_HH_REGOFF			XAIE2PGBL_CORE_MODULE_CORE_BMHH4_PART4

#define XAIE_CORE_MODULE_CORE_WL0_PART1_REGOFF		XAIE2PGBL_CORE_MODULE_CORE_WL0_PART1
#define XAIE_CORE_MODULE_CORE_WH11_PART2_REGOFF		XAIE2PGBL_CORE_MODULE_CORE_WH11_PART2

#define XAIE_CORE_MODULE_CORE_Q0_REGOFF			XAIE2PGBL_CORE_MODULE_CORE_Q0
#define XAIE_CORE_MODULE_CORE_LDFIFOH1_PART4_REGOFF	0x00030DF0

#define XAIE_CORE_MODULE_CORE_E0_REGOFF			0x00030E00
#define XAIE_CORE_MODULE_CORE_E11_REGOFF		0x00030EB0

#define XAIE_CORE_MODULE_CORE_PC_START_REGOFF		0x00030F00
#define XAIE_CORE_MODULE_CORE_PC_END_REGOFF		0x00030FC0

#define XAIE_CORE_MODULE_CORE_R0_REGOFF			0x00031000
#define XAIE_CORE_MODULE_CORE_S3_REGOFF			0x000314B0
...
#define XAIE_AIE_TILE_CLOCK_CONTROL_REGOFF				XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL
#define XAIE_AIE_TILE_CLOCK_CONTROL_MASK				XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_MASK
#define XAIE_AIE_TILE_CLOCK_CONTROL_STREAM_SWITCH_WIDTH			XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_WIDTH
#define XAIE_AIE_TILE_CLOCK_CONTROL_STREAM_SWITCH_MASK 			XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_MASK
#define XAIE_AIE_TILE_CLOCK_CONTROL_STREAM_SWITCH_DEFVAL		XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_DEFVAL

#define XAIE_MEM_TILE_CLOCK_CONTROL_REGOFF				XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL
#define XAIE_MEM_TILE_CLOCK_CONTROL_MASK				XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_MASK
#define XAIE_MEM_TILE_CLOCK_CONTROL_STREAM_SWITCH_WIDTH			XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_WIDTH
#define XAIE_MEM_TILE_CLOCK_CONTROL_STREAM_SWITCH_MASK 			XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_MASK
#define XAIE_MEM_TILE_CLOCK_CONTROL_STREAM_SWITCH_DEFVAL		XAIE2PGBL_MEM_TILE_MODULE_MODULE_MODULE_CLOCK_CONTROL_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_DEFVAL

#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_REGOFF			XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_MASK				XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_MASK
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_STREAM_SWITCH_WIDTH		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_WIDTH
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_STREAM_SWITCH_MASK 		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_MASK
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_STREAM_SWITCH_DEFVAL		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_STREAM_SWITCH_ADAPTIVE_CLOCK_GATE_DEFVAL

#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_CTE_CLOCK_ENABLE_LSB			XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_CTE_CLOCK_ENABLE_LSB
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_CTE_CLOCK_ENABLE_MASK		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_CTE_CLOCK_ENABLE_MASK
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_PL_INTERFACE_CLOCK_ENABLE_LSB	XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_PL_INTERFACE_CLOCK_ENABLE_LSB
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_PL_INTERFACE_CLOCK_ENABLE_MASK	XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_PL_INTERFACE_CLOCK_ENABLE_MASK
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_STREAM_SWITCH_CLOCK_ENABLE_LSB	XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_STREAM_SWITCH_CLOCK_ENABLE_LSB
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_STREAM_SWITCH_CLOCK_ENABLE_MASK	XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_STREAM_SWITCH_CLOCK_ENABLE_MASK

#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_1_REGOFF				XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_1
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_1_MASK					XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_1_MASK
#define XAIE_SHIM_TILE_NOC_MOD_CLOCK_CONTROL_1_CLOCK_ENABLE_LSB			XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_1_NOC_MODULE_CLOCK_ENABLE_LSB
#define XAIE_SHIM_TILE_NOC_MOD_CLOCK_CONTROL_1_CLOCK_ENABLE_MASK		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_1_NOC_MODULE_CLOCK_ENABLE_MASK
