...
{
	.RegOff = XAIEGBL_CORE_CORESTA,
	/* Done bit mask is not included in the core status mask because of the
	   hardware bug*/
	.Mask = XAIEGBL_CORE_CORESTA_ERRHLT_MASK |
		XAIEGBL_CORE_CORESTA_ECCSCRSTAL_MASK |
		XAIEGBL_CORE_CORESTA_ECCERRSTAL_MASK |
		XAIEGBL_CORE_CORESTA_DBGHLT_MASK |
		XAIEGBL_CORE_CORESTA_CASSTALMCD_MASK |
		XAIEGBL_CORE_CORESTA_CASSTALSCD_MASK |
		XAIEGBL_CORE_CORESTA_STRSTALMS1_MASK |
		XAIEGBL_CORE_CORESTA_STRSTALMS0_MASK |
		XAIEGBL_CORE_CORESTA_STRSTALSS1_MASK |
		XAIEGBL_CORE_CORESTA_STRSTALSS0_MASK |
		XAIEGBL_CORE_CORESTA_LOCKSTALE_MASK |
		XAIEGBL_CORE_CORESTA_LOCKSTALN_MASK |
		XAIEGBL_CORE_CORESTA_LOCKSTALW_MASK |
		XAIEGBL_CORE_CORESTA_LOCKSTALS_MASK |
		XAIEGBL_CORE_CORESTA_MEMSTALE_MASK |
		XAIEGBL_CORE_CORESTA_MEMSTALN_MASK |
		XAIEGBL_CORE_CORESTA_MEMSTALW_MASK |
		XAIEGBL_CORE_CORESTA_MEMSTALS_MASK |
		XAIEGBL_CORE_CORESTA_RST_MASK | XAIEGBL_CORE_CORESTA_ENA_MASK,
	.Done = {XAIEGBL_CORE_CORESTA_COREDON_LSB,
		XAIEGBL_CORE_CORESTA_COREDON_MASK},
	.Rst = {XAIEGBL_CORE_CORESTA_RST_LSB,XAIEGBL_CORE_CORESTA_RST_MASK},
	.En = {XAIEGBL_CORE_CORESTA_ENA_LSB, XAIEGBL_CORE_CORESTA_ENA_MASK}
};
...
static const XAie_CoreMod AieCoreMod =
{
	...
	.GetCoreStatus = &_XAie_CoreGetStatus
};
#endif /* XAIE_FEATURE_CORE_ENABLE */
...
static const XAie_DmaMod AieTileDmaMod =
{
	...
	.SetBdIter = &_XAie_DmaSetBdIteration,
	.WriteBdPrep = &_XAie_TileDmaWriteBdPrep,
	.WriteBd = &_XAie_TileDmaWriteBd,
	.ReadBd = &_XAie_TileDmaReadBd,
...
static const XAie_DmaMod AieShimDmaMod =
{
	...
	.SetMultiDim = NULL,
	.SetBdIter = &_XAie_DmaSetBdIteration,
	.WriteBdPrep = &_XAie_ShimDmaWriteBdPrep,
	.WriteBd = &_XAie_ShimDmaWriteBd,
	.ReadBd = &_XAie_ShimDmaReadBd,
	.PendingBd = &_XAie_DmaGetPendingBdCount,
	.WaitforDone = &_XAie_DmaWaitForDone,
	.BdChValidity = &_XAie_DmaCheckBdChValidity,
...
#define XAIE_EVENT_CORE_MAP(EVENT)	[XAIE_EVENT_##EVENT##_CORE] = XAIE_EVENTS_CORE_##EVENT
#define XAIE_EVENT_MEM_MAP(EVENT)	[XAIE_EVENT_##EVENT##_MEM] = XAIE_EVENTS_MEM_##EVENT
#define XAIE_EVENT_PL_MAP(EVENT)	[XAIE_EVENT_##EVENT##_PL] = XAIE_EVENTS_PL_##EVENT

static const u16 AieEventMapping[] =
{
	/* Enum to Event Number mapping of all events of AIE Core module */
	XAIE_EVENT_CORE_MAP(NONE),
	XAIE_EVENT_CORE_MAP(TRUE),
	XAIE_EVENT_CORE_MAP(GROUP_0),
	XAIE_EVENT_CORE_MAP(TIMER_SYNC),
	XAIE_EVENT_CORE_MAP(TIMER_VALUE_REACHED),
	XAIE_EVENT_CORE_MAP(PERF_CNT_0),
	XAIE_EVENT_CORE_MAP(PERF_CNT_1),
	XAIE_EVENT_CORE_MAP(PERF_CNT_2),
	XAIE_EVENT_CORE_MAP(PERF_CNT_3),
	[XAIE_EVENT_PERF_CNT_4_CORE ... XAIE_EVENT_PERF_CNT_11_CORE] = XAIE_EVENT_INVALID,
	XAIE_EVENT_CORE_MAP(COMBO_EVENT_0),
	XAIE_EVENT_CORE_MAP(COMBO_EVENT_1),
	XAIE_EVENT_CORE_MAP(COMBO_EVENT_2),
	XAIE_EVENT_CORE_MAP(COMBO_EVENT_3),
	XAIE_EVENT_CORE_MAP(GROUP_PC_EVENT),
	XAIE_EVENT_CORE_MAP(PC_0),
	XAIE_EVENT_CORE_MAP(PC_1),
	XAIE_EVENT_CORE_MAP(PC_2),
	XAIE_EVENT_CORE_MAP(PC_3),
	XAIE_EVENT_CORE_MAP(PC_RANGE_0_1),
	XAIE_EVENT_CORE_MAP(PC_RANGE_2_3),
	[XAIE_EVENT_GROUP_CORE_STALL_CORE] = XAIE_EVENTS_CORE_GROUP_STALL,
	XAIE_EVENT_CORE_MAP(MEMORY_STALL),
	XAIE_EVENT_CORE_MAP(STREAM_STALL),
	XAIE_EVENT_CORE_MAP(CASCADE_STALL),
	XAIE_EVENT_CORE_MAP(LOCK_STALL),
	XAIE_EVENT_CORE_MAP(DEBUG_HALTED),
	XAIE_EVENT_CORE_MAP(ACTIVE),
	XAIE_EVENT_CORE_MAP(DISABLED),
	XAIE_EVENT_CORE_MAP(ECC_ERROR_STALL),
	XAIE_EVENT_CORE_MAP(ECC_SCRUBBING_STALL),
	[XAIE_EVENT_GROUP_CORE_PROGRAM_FLOW_CORE] = XAIE_EVENTS_CORE_GROUP_PROGRAM_FLOW,
	XAIE_EVENT_CORE_MAP(INSTR_EVENT_0),
	XAIE_EVENT_CORE_MAP(INSTR_EVENT_1),
	XAIE_EVENT_CORE_MAP(INSTR_CALL),
	XAIE_EVENT_CORE_MAP(INSTR_RETURN),
	XAIE_EVENT_CORE_MAP(INSTR_VECTOR),
	XAIE_EVENT_CORE_MAP(INSTR_LOAD),
	XAIE_EVENT_CORE_MAP(INSTR_STORE),
	XAIE_EVENT_CORE_MAP(INSTR_STREAM_GET),
	XAIE_EVENT_CORE_MAP(INSTR_STREAM_PUT),
	XAIE_EVENT_CORE_MAP(INSTR_CASCADE_GET),
	XAIE_EVENT_CORE_MAP(INSTR_CASCADE_PUT),
	XAIE_EVENT_CORE_MAP(INSTR_LOCK_ACQUIRE_REQ),
	XAIE_EVENT_CORE_MAP(INSTR_LOCK_RELEASE_REQ),
	XAIE_EVENT_CORE_MAP(GROUP_ERRORS_0),
	XAIE_EVENT_CORE_MAP(GROUP_ERRORS_1),
	XAIE_EVENT_CORE_MAP(SRS_SATURATE),
	XAIE_EVENT_CORE_MAP(UPS_SATURATE),
	XAIE_EVENT_CORE_MAP(FP_OVERFLOW),
	XAIE_EVENT_CORE_MAP(FP_UNDERFLOW),
	XAIE_EVENT_CORE_MAP(FP_INVALID),
	XAIE_EVENT_CORE_MAP(FP_DIV_BY_ZERO),
	XAIE_EVENT_CORE_MAP(TLAST_IN_WSS_WORDS_0_2),
	XAIE_EVENT_CORE_MAP(PM_REG_ACCESS_FAILURE),
	XAIE_EVENT_CORE_MAP(STREAM_PKT_PARITY_ERROR),
	XAIE_EVENT_CORE_MAP(CONTROL_PKT_ERROR),
	XAIE_EVENT_CORE_MAP(AXI_MM_SLAVE_ERROR),
	XAIE_EVENT_CORE_MAP(INSTR_DECOMPRSN_ERROR),
	XAIE_EVENT_CORE_MAP(DM_ADDRESS_OUT_OF_RANGE),
	XAIE_EVENT_CORE_MAP(PM_ECC_ERROR_SCRUB_CORRECTED),
	XAIE_EVENT_CORE_MAP(PM_ECC_ERROR_SCRUB_2BIT),
	XAIE_EVENT_CORE_MAP(PM_ECC_ERROR_1BIT),
	XAIE_EVENT_CORE_MAP(PM_ECC_ERROR_2BIT),
	XAIE_EVENT_CORE_MAP(PM_ADDRESS_OUT_OF_RANGE),
	XAIE_EVENT_CORE_MAP(DM_ACCESS_TO_UNAVAILABLE),
	XAIE_EVENT_CORE_MAP(LOCK_ACCESS_TO_UNAVAILABLE),
	[XAIE_EVENT_INSTR_EVENT_2] = XAIE_EVENTS_CORE_INSTR_EVENT_2,
	[XAIE_EVENT_INSTR_EVENT_3] = XAIE_EVENTS_CORE_INSTR_EVENT_3,
	XAIE_EVENT_CORE_MAP(GROUP_STREAM_SWITCH),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_0),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_0),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_0),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_0),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_1),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_1),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_1),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_1),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_2),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_2),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_2),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_2),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_3),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_3),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_3),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_3),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_4),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_4),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_4),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_4),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_5),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_5),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_5),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_5),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_6),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_6),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_6),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_6),
	XAIE_EVENT_CORE_MAP(PORT_IDLE_7),
	XAIE_EVENT_CORE_MAP(PORT_RUNNING_7),
	XAIE_EVENT_CORE_MAP(PORT_STALLED_7),
	XAIE_EVENT_CORE_MAP(PORT_TLAST_7),
	XAIE_EVENT_CORE_MAP(GROUP_BROADCAST),
	XAIE_EVENT_CORE_MAP(BROADCAST_0),
	XAIE_EVENT_CORE_MAP(BROADCAST_1),
	XAIE_EVENT_CORE_MAP(BROADCAST_2),
	XAIE_EVENT_CORE_MAP(BROADCAST_3),
	XAIE_EVENT_CORE_MAP(BROADCAST_4),
	XAIE_EVENT_CORE_MAP(BROADCAST_5),
	XAIE_EVENT_CORE_MAP(BROADCAST_6),
	XAIE_EVENT_CORE_MAP(BROADCAST_7),
	XAIE_EVENT_CORE_MAP(BROADCAST_8),
	XAIE_EVENT_CORE_MAP(BROADCAST_9),
	XAIE_EVENT_CORE_MAP(BROADCAST_10),
	XAIE_EVENT_CORE_MAP(BROADCAST_11),
	XAIE_EVENT_CORE_MAP(BROADCAST_12),
	XAIE_EVENT_CORE_MAP(BROADCAST_13),
	XAIE_EVENT_CORE_MAP(BROADCAST_14),
	XAIE_EVENT_CORE_MAP(BROADCAST_15),
	XAIE_EVENT_CORE_MAP(GROUP_USER_EVENT),
	XAIE_EVENT_CORE_MAP(USER_EVENT_0),
	XAIE_EVENT_CORE_MAP(USER_EVENT_1),
	XAIE_EVENT_CORE_MAP(USER_EVENT_2),
	XAIE_EVENT_CORE_MAP(USER_EVENT_3),

	/* Enum to Event Number mapping of all events of AIE Mem module */
	XAIE_EVENT_MEM_MAP(NONE),
	XAIE_EVENT_MEM_MAP(TRUE),
	XAIE_EVENT_MEM_MAP(GROUP_0),
	XAIE_EVENT_MEM_MAP(TIMER_SYNC),
	XAIE_EVENT_MEM_MAP(TIMER_VALUE_REACHED),
	XAIE_EVENT_MEM_MAP(PERF_CNT_0),
	XAIE_EVENT_MEM_MAP(PERF_CNT_1),
	XAIE_EVENT_MEM_MAP(COMBO_EVENT_0),
	XAIE_EVENT_MEM_MAP(COMBO_EVENT_1),
	XAIE_EVENT_MEM_MAP(COMBO_EVENT_2),
	XAIE_EVENT_MEM_MAP(COMBO_EVENT_3),
	XAIE_EVENT_MEM_MAP(GROUP_WATCHPOINT),
	XAIE_EVENT_MEM_MAP(WATCHPOINT_0),
	XAIE_EVENT_MEM_MAP(WATCHPOINT_1),
	XAIE_EVENT_MEM_MAP(GROUP_DMA_ACTIVITY),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_START_BD),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_START_BD),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_START_BD),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_START_BD),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_FINISHED_BD),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_FINISHED_BD),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_FINISHED_BD),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_FINISHED_BD),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_GO_TO_IDLE),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_GO_TO_IDLE),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_GO_TO_IDLE),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_GO_TO_IDLE),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_MEMORY_CONFLICT),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_MEMORY_CONFLICT),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_MEMORY_CONFLICT),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_MEMORY_CONFLICT),
	XAIE_EVENT_MEM_MAP(GROUP_LOCK),
	XAIE_EVENT_MEM_MAP(LOCK_0_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_0_REL),
	XAIE_EVENT_MEM_MAP(LOCK_1_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_1_REL),
	XAIE_EVENT_MEM_MAP(LOCK_2_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_2_REL),
	XAIE_EVENT_MEM_MAP(LOCK_3_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_3_REL),
	XAIE_EVENT_MEM_MAP(LOCK_4_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_4_REL),
	XAIE_EVENT_MEM_MAP(LOCK_5_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_5_REL),
	XAIE_EVENT_MEM_MAP(LOCK_6_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_6_REL),
	XAIE_EVENT_MEM_MAP(LOCK_7_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_7_REL),
	XAIE_EVENT_MEM_MAP(LOCK_8_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_8_REL),
	XAIE_EVENT_MEM_MAP(LOCK_9_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_9_REL),
	XAIE_EVENT_MEM_MAP(LOCK_10_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_10_REL),
	XAIE_EVENT_MEM_MAP(LOCK_11_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_11_REL),
	XAIE_EVENT_MEM_MAP(LOCK_12_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_12_REL),
	XAIE_EVENT_MEM_MAP(LOCK_13_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_13_REL),
	XAIE_EVENT_MEM_MAP(LOCK_14_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_14_REL),
	XAIE_EVENT_MEM_MAP(LOCK_15_ACQ),
	XAIE_EVENT_MEM_MAP(LOCK_15_REL),
	XAIE_EVENT_MEM_MAP(GROUP_MEMORY_CONFLICT),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_0),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_1),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_2),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_3),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_4),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_5),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_6),
	XAIE_EVENT_MEM_MAP(CONFLICT_DM_BANK_7),
	XAIE_EVENT_MEM_MAP(GROUP_ERRORS),
	XAIE_EVENT_MEM_MAP(DM_ECC_ERROR_SCRUB_CORRECTED),
	XAIE_EVENT_MEM_MAP(DM_ECC_ERROR_SCRUB_2BIT),
	XAIE_EVENT_MEM_MAP(DM_ECC_ERROR_1BIT),
	XAIE_EVENT_MEM_MAP(DM_ECC_ERROR_2BIT),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_2),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_3),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_4),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_5),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_6),
	XAIE_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_7),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_0_ERROR),
	XAIE_EVENT_MEM_MAP(DMA_S2MM_1_ERROR),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_0_ERROR),
	XAIE_EVENT_MEM_MAP(DMA_MM2S_1_ERROR),
	XAIE_EVENT_MEM_MAP(GROUP_BROADCAST),
	XAIE_EVENT_MEM_MAP(BROADCAST_0),
	XAIE_EVENT_MEM_MAP(BROADCAST_1),
	XAIE_EVENT_MEM_MAP(BROADCAST_2),
	XAIE_EVENT_MEM_MAP(BROADCAST_3),
	XAIE_EVENT_MEM_MAP(BROADCAST_4),
	XAIE_EVENT_MEM_MAP(BROADCAST_5),
	XAIE_EVENT_MEM_MAP(BROADCAST_6),
	XAIE_EVENT_MEM_MAP(BROADCAST_7),
	XAIE_EVENT_MEM_MAP(BROADCAST_8),
	XAIE_EVENT_MEM_MAP(BROADCAST_9),
	XAIE_EVENT_MEM_MAP(BROADCAST_10),
	XAIE_EVENT_MEM_MAP(BROADCAST_11),
	XAIE_EVENT_MEM_MAP(BROADCAST_12),
	XAIE_EVENT_MEM_MAP(BROADCAST_13),
	XAIE_EVENT_MEM_MAP(BROADCAST_14),
	XAIE_EVENT_MEM_MAP(BROADCAST_15),
	XAIE_EVENT_MEM_MAP(GROUP_USER_EVENT),
	XAIE_EVENT_MEM_MAP(USER_EVENT_0),
	XAIE_EVENT_MEM_MAP(USER_EVENT_1),
	XAIE_EVENT_MEM_MAP(USER_EVENT_2),
	XAIE_EVENT_MEM_MAP(USER_EVENT_3),

	/* Enum to Event Number mapping of all events of AIE PL module */
	XAIE_EVENT_PL_MAP(NONE),
	XAIE_EVENT_PL_MAP(TRUE),
	XAIE_EVENT_PL_MAP(GROUP_0),
	XAIE_EVENT_PL_MAP(TIMER_SYNC),
	XAIE_EVENT_PL_MAP(TIMER_VALUE_REACHED),
	XAIE_EVENT_PL_MAP(PERF_CNT_0),
	XAIE_EVENT_PL_MAP(PERF_CNT_1),
	XAIE_EVENT_PL_MAP(COMBO_EVENT_0),
	XAIE_EVENT_PL_MAP(COMBO_EVENT_1),
	XAIE_EVENT_PL_MAP(COMBO_EVENT_2),
	XAIE_EVENT_PL_MAP(COMBO_EVENT_3),
	XAIE_EVENT_PL_MAP(GROUP_ERRORS),
	XAIE_EVENT_PL_MAP(AXI_MM_SLAVE_TILE_ERROR),
	XAIE_EVENT_PL_MAP(CONTROL_PKT_ERROR),
	XAIE_EVENT_PL_MAP(GROUP_STREAM_SWITCH),
	XAIE_EVENT_PL_MAP(PORT_IDLE_0),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_0),
	XAIE_EVENT_PL_MAP(PORT_STALLED_0),
	XAIE_EVENT_PL_MAP(PORT_TLAST_0),
	XAIE_EVENT_PL_MAP(PORT_IDLE_1),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_1),
	XAIE_EVENT_PL_MAP(PORT_STALLED_1),
	XAIE_EVENT_PL_MAP(PORT_TLAST_1),
	XAIE_EVENT_PL_MAP(PORT_IDLE_2),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_2),
	XAIE_EVENT_PL_MAP(PORT_STALLED_2),
	XAIE_EVENT_PL_MAP(PORT_TLAST_2),
	XAIE_EVENT_PL_MAP(PORT_IDLE_3),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_3),
	XAIE_EVENT_PL_MAP(PORT_STALLED_3),
	XAIE_EVENT_PL_MAP(PORT_TLAST_3),
	XAIE_EVENT_PL_MAP(PORT_IDLE_4),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_4),
	XAIE_EVENT_PL_MAP(PORT_STALLED_4),
	XAIE_EVENT_PL_MAP(PORT_TLAST_4),
	XAIE_EVENT_PL_MAP(PORT_IDLE_5),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_5),
	XAIE_EVENT_PL_MAP(PORT_STALLED_5),
	XAIE_EVENT_PL_MAP(PORT_TLAST_5),
	XAIE_EVENT_PL_MAP(PORT_IDLE_6),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_6),
	XAIE_EVENT_PL_MAP(PORT_STALLED_6),
	XAIE_EVENT_PL_MAP(PORT_TLAST_6),
	XAIE_EVENT_PL_MAP(PORT_IDLE_7),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_7),
	XAIE_EVENT_PL_MAP(PORT_STALLED_7),
	XAIE_EVENT_PL_MAP(PORT_TLAST_7),
	XAIE_EVENT_PL_MAP(GROUP_BROADCAST_A),
	XAIE_EVENT_PL_MAP(BROADCAST_A_0),
	XAIE_EVENT_PL_MAP(BROADCAST_A_1),
	XAIE_EVENT_PL_MAP(BROADCAST_A_2),
	XAIE_EVENT_PL_MAP(BROADCAST_A_3),
	XAIE_EVENT_PL_MAP(BROADCAST_A_4),
	XAIE_EVENT_PL_MAP(BROADCAST_A_5),
	XAIE_EVENT_PL_MAP(BROADCAST_A_6),
	XAIE_EVENT_PL_MAP(BROADCAST_A_7),
	XAIE_EVENT_PL_MAP(BROADCAST_A_8),
	XAIE_EVENT_PL_MAP(BROADCAST_A_9),
	XAIE_EVENT_PL_MAP(BROADCAST_A_10),
	XAIE_EVENT_PL_MAP(BROADCAST_A_11),
	XAIE_EVENT_PL_MAP(BROADCAST_A_12),
	XAIE_EVENT_PL_MAP(BROADCAST_A_13),
	XAIE_EVENT_PL_MAP(BROADCAST_A_14),
	XAIE_EVENT_PL_MAP(BROADCAST_A_15),
	XAIE_EVENT_PL_MAP(GROUP_USER_EVENT),
	XAIE_EVENT_PL_MAP(USER_EVENT_0),
	XAIE_EVENT_PL_MAP(USER_EVENT_1),
	XAIE_EVENT_PL_MAP(USER_EVENT_2),
	XAIE_EVENT_PL_MAP(USER_EVENT_3),
...
static const u16 AieTileNocModEventMapping[] =
{
	...
	XAIE_EVENT_PL_MAP(COMBO_EVENT_2),
	XAIE_EVENT_PL_MAP(COMBO_EVENT_3),
	XAIE_EVENT_PL_MAP(GROUP_DMA_ACTIVITY),
	XAIE_EVENT_PL_MAP(DMA_S2MM_0_START_BD),
	XAIE_EVENT_PL_MAP(DMA_S2MM_1_START_BD),
	XAIE_EVENT_PL_MAP(DMA_MM2S_0_START_BD),
	XAIE_EVENT_PL_MAP(DMA_MM2S_1_START_BD),
	XAIE_EVENT_PL_MAP(DMA_S2MM_0_FINISHED_BD),
	XAIE_EVENT_PL_MAP(DMA_S2MM_1_FINISHED_BD),
	XAIE_EVENT_PL_MAP(DMA_MM2S_0_FINISHED_BD),
	XAIE_EVENT_PL_MAP(DMA_MM2S_1_FINISHED_BD),
	XAIE_EVENT_PL_MAP(DMA_S2MM_0_GO_TO_IDLE),
	XAIE_EVENT_PL_MAP(DMA_S2MM_1_GO_TO_IDLE),
	XAIE_EVENT_PL_MAP(DMA_MM2S_0_GO_TO_IDLE),
	XAIE_EVENT_PL_MAP(DMA_MM2S_1_GO_TO_IDLE),
	XAIE_EVENT_PL_MAP(DMA_S2MM_0_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_PL_MAP(DMA_S2MM_1_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_PL_MAP(DMA_MM2S_0_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_PL_MAP(DMA_MM2S_1_STALLED_LOCK_ACQUIRE),
	XAIE_EVENT_PL_MAP(GROUP_LOCK),
	XAIE_EVENT_PL_MAP(LOCK_0_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_0_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_1_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_1_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_2_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_2_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_3_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_3_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_4_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_4_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_5_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_5_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_6_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_6_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_7_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_7_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_8_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_8_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_9_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_9_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_10_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_10_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_11_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_11_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_12_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_12_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_13_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_13_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_14_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_14_RELEASED),
	XAIE_EVENT_PL_MAP(LOCK_15_ACQUIRED),
	XAIE_EVENT_PL_MAP(LOCK_15_RELEASED),
	XAIE_EVENT_PL_MAP(GROUP_ERRORS),
	XAIE_EVENT_PL_MAP(AXI_MM_SLAVE_TILE_ERROR),
	XAIE_EVENT_PL_MAP(CONTROL_PKT_ERROR),
	XAIE_EVENT_PL_MAP(AXI_MM_DECODE_NSU_ERROR),
	XAIE_EVENT_PL_MAP(AXI_MM_SLAVE_NSU_ERROR),
	XAIE_EVENT_PL_MAP(AXI_MM_UNSUPPORTED_TRAFFIC),
	XAIE_EVENT_PL_MAP(AXI_MM_UNSECURE_ACCESS_IN_SECURE_MODE),
	XAIE_EVENT_PL_MAP(AXI_MM_BYTE_STROBE_ERROR),
	XAIE_EVENT_PL_MAP(DMA_S2MM_0_ERROR),
	XAIE_EVENT_PL_MAP(DMA_S2MM_1_ERROR),
	XAIE_EVENT_PL_MAP(DMA_MM2S_0_ERROR),
	XAIE_EVENT_PL_MAP(DMA_MM2S_1_ERROR),
	XAIE_EVENT_PL_MAP(GROUP_STREAM_SWITCH),
	XAIE_EVENT_PL_MAP(PORT_IDLE_0),
	XAIE_EVENT_PL_MAP(PORT_RUNNING_0),
	XAIE_EVENT_PL_MAP(PORT_STALLED_0),
...
{
	{
		.XAie_EventNumber = AieEventMapping,
		.EventMin = (u32)XAIE_EVENT_NONE_MEM,
		.EventMax = (u32)XAIE_EVENT_USER_EVENT_3_MEM,
		...
		.EdgeDetectTrigger = {XAIE_FEATURE_UNAVAILABLE, XAIE_FEATURE_UNAVAILABLE},
		.EdgeEventSelectIdOff = XAIE_FEATURE_UNAVAILABLE,
		.NumEdgeSelectIds = XAIE_FEATURE_UNAVAILABLE,
	...
	},
	{
		...
		.EventMax = (u32)XAIE_EVENT_USER_EVENT_3_CORE,
...
static const XAie_EvntMod AieNocEvntMod =
{
	...
	.EventMax = (u32)XAIE_EVENT_USER_EVENT_3_PL,
...
static const XAie_L1IntrMod AiePlL1IntrMod =
{
	...
	.IntrCtrlL1IrqId = &_XAie_IntrCtrlL1IrqId,
#else
...
#ifdef XAIE_FEATURE_CORE_ENABLE
	#define AIECOREMOD &AieCoreMod
#else
	#define AIECOREMOD NULL
#endif
#ifdef XAIE_FEATURE_SS_ENABLE
	#define AIETILESTRMSW &AieTileStrmSw
	#define AIESHIMSTRMSW &AieShimStrmSw
#else
	#define AIETILESTRMSW NULL
	#define AIESHIMSTRMSW NULL
#endif
#ifdef XAIE_FEATURE_DMA_ENABLE
	#define AIETILEDMAMOD &AieTileDmaMod
	#define AIESHIMDMAMOD &AieShimDmaMod
#else
	#define AIETILEDMAMOD NULL
	#define AIESHIMDMAMOD NULL
#endif
#ifdef XAIE_FEATURE_DATAMEM_ENABLE
	#define AIETILEMEMMOD &AieTileMemMod
#else
	#define AIETILEMEMMOD NULL
#endif
#ifdef XAIE_FEATURE_LOCK_ENABLE
	#define AIETILELOCKMOD &AieTileLockMod
	#define AIESHIMNOCLOCKMOD &AieShimNocLockMod
#else
	#define AIETILELOCKMOD NULL
	#define AIESHIMNOCLOCKMOD NULL
#endif
#ifdef XAIE_FEATURE_PERFCOUNT_ENABLE
	#define AIETILEPERFCNT AieTilePerfCnt
	#define AIEPLPERFCNT &AiePlPerfCnt
#else
	#define AIETILEPERFCNT NULL
	#define AIEPLPERFCNT NULL
#endif
#ifdef XAIE_FEATURE_EVENTS_ENABLE
	#define AIETILEEVNTMOD AieTileEvntMod
	#define AIENOCEVNTMOD &AieNocEvntMod
	#define AIEPLEVNTMOD &AiePlEvntMod
#else
	#define AIETILEEVNTMOD NULL
	#define AIENOCEVNTMOD NULL
	#define AIEPLEVNTMOD NULL
#endif
#ifdef XAIE_FEATURE_TIMER_ENABLE
	#define AIETILETIMERMOD AieTileTimerMod
	#define AIEPLTIMERMOD &AiePlTimerMod
#else
	#define AIETILETIMERMOD NULL
	#define AIEPLTIMERMOD NULL
#endif
#ifdef XAIE_FEATURE_TRACE_ENABLE
	#define AIETILETRACEMOD AieTileTraceMod
	#define AIEPLTRACEMOD &AiePlTraceMod
#else
	#define AIETILETRACEMOD NULL
	#define AIEPLTRACEMOD NULL
#endif
#ifdef XAIE_FEATURE_PL_ENABLE
	#define AIESHIMTILEPLIFMOD &AieShimTilePlIfMod
	#define AIEPLIFMOD &AiePlIfMod
#else
	#define AIESHIMTILEPLIFMOD NULL
	#define AIEPLIFMOD NULL
#endif
#ifdef XAIE_FEATURE_INTR_L1_ENABLE
	#define AIEPLL1INTRMOD &AiePlL1IntrMod
#else
	#define AIEPLL1INTRMOD NULL
#endif
#ifdef XAIE_FEATURE_INTR_L2_ENABLE
	#define AIENOCL2INTRMOD &AieNoCL2IntrMod
#else
	#define AIENOCL2INTRMOD NULL
#endif
#ifdef XAIE_FEATURE_PRIVILEGED_ENABLE
	#define AIETILECLOCKMOD &AieTileClockMod
	#define AIECORETILECTRLMOD &AieCoreTileCtrlMod
	#define AIEPLCLOCKMOD &AiePlClockMod
	#define AIESHIMTILECTRLMOD &AieShimTileCtrlMod
#else
	#define AIETILECLOCKMOD NULL
	#define AIECORETILECTRLMOD NULL
	#define AIEPLCLOCKMOD NULL
	#define AIESHIMTILECTRLMOD NULL
#endif
/*
 * AIE Module
