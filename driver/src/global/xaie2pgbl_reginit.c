...
/**************************** Macro Definitions ******************************/
/*
 * Bitmap size for AIE2P. Set to 0 to disable bitmap tracking for this
...
static const XAie_DmaChStatus Aie2PMemTileDmaChStatus =
{
	...
	.AieMlDmaChStatus.TaskQOverFlow.Lsb = XAIE2PGBL_MEM_TILE_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_LSB,
	.AieMlDmaChStatus.TaskQOverFlow.Mask = XAIE2PGBL_MEM_TILE_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_MASK,
};
...
static const XAie_DmaChStatus Aie2PTileDmaChStatus =
{
	...
	.AieMlDmaChStatus.TaskQOverFlow.Lsb = XAIE2PGBL_MEMORY_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_LSB,
	.AieMlDmaChStatus.TaskQOverFlow.Mask = XAIE2PGBL_MEMORY_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_MASK,
};
...
static const XAie_DmaChStatus Aie2PShimDmaChStatus =
{
	...
	.AieMlDmaChStatus.TaskQOverFlow.Lsb = XAIE2PGBL_NOC_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_LSB,
	.AieMlDmaChStatus.TaskQOverFlow.Mask = XAIE2PGBL_NOC_MODULE_DMA_S2MM_STATUS_0_TASK_QUEUE_OVERFLOW_MASK,
};
...
/* Device level operations for aie2p */
const XAie_DeviceOps Aie2PDevOps =
{
	.IsCheckerBoard = 0U,
#if (XAIE2P_TILES_BITMAPSIZE > 0U)
