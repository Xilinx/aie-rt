...
static const u16 AieMlPlModEventMapping[] =
{
	XAIEML_EVENTS_PL_NONE,
	XAIEML_EVENTS_PL_TRUE,
	XAIEML_EVENTS_PL_GROUP_0,
...
static const XAie_MemCtrlMod AieMlMemTileMemCtrlMod =
{
	...
	.MemInterleaving = {XAIEMLGBL_MEM_TILE_MODULE_MEMORY_CONTROL_MEMORY_INTERLEAVING_LSB, XAIEMLGBL_MEM_TILE_MODULE_MEMORY_CONTROL_MEMORY_INTERLEAVING_MASK},
};
#endif /* XAIE_FEATURE_PRIVILEGED_ENABLE */
...
const XAie_DeviceOps AieMlDevOps =
{
	.IsCheckerBoard = 0U,
