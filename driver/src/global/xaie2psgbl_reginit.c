...
static const XAie_EventGroup Aie2PSPlGroupEvent[] =
{
	...
	},
	{
		...
		.GroupOff = 1U,
		.GroupMask = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_DMA_ACTIVITY_ENABLE_MASK,
		.ResetValue = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_DMA_ACTIVITY_ENABLE_MASK,
	},

	{
		.GroupEvent = XAIE_EVENT_GROUP_LOCK_PL,
		.GroupOff = 2U,
		.GroupMask = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_LOCK_ENABLE_MASK,
		.ResetValue = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_LOCK_ENABLE_MASK,
	},
	{
		.GroupEvent = XAIE_EVENT_GROUP_ERRORS_PL,
		.GroupOff = 3U,
		.GroupMask = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_ERRORS_ENABLE_MASK,
		.ResetValue = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_ERRORS_ENABLE_MASK,
	},
	{
		.GroupEvent = XAIE_EVENT_GROUP_STREAM_SWITCH_PL,
		.GroupOff = 4U,
		.GroupMask = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_STREAM_SWITCH_ENABLE_MASK,
		.ResetValue = XAIE2PSGBL_PL_NORTH_MODULE_EVENT_GROUP_STREAM_SWITCH_ENABLE_MASK,
	},
	{
