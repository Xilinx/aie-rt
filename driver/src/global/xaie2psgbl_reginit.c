...
* ----- ------     --------     -----------------------------------------------------
* 1.0   Sankarji   07/11/2022  Initial creation
* 1.2   Gregory    07/26/2024  Ported file to main-aie
* </pre>
*
******************************************************************************/
...
/**************************** Macro Definitions ******************************/
#ifdef _MSC_VER
#define XAIE2PS_TILES_BITMAPSIZE	16U
#else
#define XAIE2PS_TILES_BITMAPSIZE	16U
#endif
...
static const XAie_RegUcDmaPause Aie2PSUcDmaPauseReg =
{
	.RegOff = XAIE2PSGBL_UC_MODULE_DMA_PAUSE,
	.Mm2dm = {XAIE2PSGBL_UC_MODULE_DMA_PAUSE_MM2DM_LSB,
		  XAIE2PSGBL_UC_MODULE_DMA_PAUSE_MM2DM_MASK},
	.Dm2mm = {XAIE2PSGBL_UC_MODULE_DMA_PAUSE_DM2MM_LSB,
		  XAIE2PSGBL_UC_MODULE_DMA_PAUSE_DM2MM_MASK}
};
#endif

static const XAie_RegNocDmaPause Aie2PSNocDmaPauseReg =
{
	.RegOff = XAIE2PSGBL_NOC_MODULE_DMA_PAUSE,
	.Mm2s_1 = {XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_MM2S_1_LSB,
		   XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_MM2S_1_MASK},
	.Mm2s_0 = {XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_MM2S_0_LSB,
		   XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_MM2S_0_MASK},
	.S2mm_1 = {XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_S2MM_1_LSB,
		   XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_S2MM_1_MASK},
	.S2mm_0 = {XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_S2MM_0_LSB,
		   XAIE2PSGBL_NOC_MODULE_DMA_PAUSE_S2MM_0_MASK}
};
#endif /*XAIE_FEATURE_PRIVILEGED_ENABLE*/

static const XAie_RegNocDmaOutsTxn Aie2psNocDmaOutstandingTxnReg =
{
	.RegOff = XAIE2PSGBL_NOC_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS,
	.NoCModuleToNMU = {XAIE2PSGBL_NOC_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_NOC_MODULE_TO_NMU_LSB,
			   XAIE2PSGBL_NOC_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_NOC_MODULE_TO_NMU_MASK}
};

#ifdef XAIE_FEATURE_UC_ENABLE
static const XAie_RegUcDmaOutsTxn Aie2psUcDmaOutstandingTxnReg =
{
	.RegOff = XAIE2PSGBL_UC_MODULE_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS,
	.UcModuleToArray = {XAIE2PSGBL_UC_MODULE_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_UC_MODULE_TO_ARRAY_LSB,
			    XAIE2PSGBL_UC_MODULE_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_UC_MODULE_TO_ARRAY_MASK},
	.UcDMAToNMU = {XAIE2PSGBL_UC_MODULE_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_UC_DMA_TO_NMU_LSB,
		       XAIE2PSGBL_UC_MODULE_MODULE_AXI_MM_OUTSTANDING_TRANSACTIONS_UC_DMA_TO_NMU_MASK}
};
...
static const XAie_UcMod Aie2PSUcMod =
{
	...
	.UcDmaPauseReg = &Aie2PSUcDmaPauseReg,
#else
	.UcDmaPauseReg = NULL,
#endif
...
static const XAie_DmaBdPad Aie2PSMemTilePadProp =
{
	...
	.D2_PadBeforeHigh.Idx = 2U,
	.D2_PadBeforeHigh.Lsb = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_2_D2_PAD_BEFORE_HIGH_LSB,
	.D2_PadBeforeHigh.Mask = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_2_D2_PAD_BEFORE_HIGH_MASK,
	.D1_PadBeforeHigh.Idx = 2U,
	.D1_PadBeforeHigh.Lsb = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_2_D1_PAD_BEFORE_HIGH_LSB,
	.D1_PadBeforeHigh.Mask = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_2_D1_PAD_BEFORE_HIGH_MASK,
	.D1_PadBefore.Idx = 3U,
	...
	.D2_PadAfterHigh.Idx = 6U,
	.D2_PadAfterHigh.Lsb = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_6_D2_PAD_AFTER_HIGH_LSB,
	.D2_PadAfterHigh.Mask = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_6_D2_PAD_AFTER_HIGH_MASK,
	.D1_PadAfterHigh.Idx = 6U,
	.D1_PadAfterHigh.Lsb = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_6_D1_PAD_AFTER_HIGH_LSB,
	.D1_PadAfterHigh.Mask = XAIE2PSGBL_MEM_TILE_MODULE_DMA_BD0_6_D1_PAD_AFTER_HIGH_MASK,
};
...
static const XAie_DmaMod Aie2PSMemTileDmaMod =
{
	...
	.WriteBdPrep = &_XAie2PS_MemTileDmaWriteBdPrep,
...
static const XAie_DmaMod Aie2PSTileDmaMod =
{
	...
	.SetBdIter = &_XAieMl_DmaSetBdIteration,
	.WriteBdPrep = &_XAieMl_TileDmaWriteBdPrep,
...
#if  (defined XAIE_FEATURE_PRIVILEGED_ENABLE) && (defined XAIE_FEATURE_DMA_ENABLE)
	.NocDmaPauseReg = &Aie2PSNocDmaPauseReg,
#else
	.NocDmaPauseReg = NULL,
#endif
	.NocDmaOutstandingReg = &Aie2psNocDmaOutstandingTxnReg,
	.SetLock = &_XAieMl_DmaSetLock,
	.SetIntrleave = NULL,
	.SetMultiDim = &_XAieMl_DmaSetMultiDim,
	.SetBdIter = &_XAieMl_DmaSetBdIteration,
	.WriteBdPrep = &_XAie2PS_ShimDmaWriteBdPrep,
...
static const XAie_PerfMod Aie2PSTilePerfCnt[] =
{
	{	.MaxCounterVal = 2U,
		...
		.PerfCtrlOffsetAdd = 0x8U,
		.PerfCtrlOffsetGap = 0x4U,
		.PerfCtrlResetBaseAddr = XAIE2PSGBL_MEMORY_MODULE_PERFORMANCE_CONTROL1,
		.PerfCtrlResetOffsetAdd = 0x8U,
		.PerfCtrlResetPerReg = 0x2U,
	...
	{	.MaxCounterVal = 4U,
		...
		.PerfCtrlOffsetAdd = 0x4U,
		.PerfCtrlOffsetGap = 0x0U,
		.PerfCtrlResetBaseAddr = XAIE2PSGBL_CORE_MODULE_PERFORMANCE_CONTROL2,
		.PerfCtrlResetOffsetAdd = 0x0U,
		.PerfCtrlResetPerReg = 0x4U,
...
#define XAIE2PS_EVENT_CORE_MAP(EVENT)		[XAIE_EVENT_##EVENT##_CORE] = XAIE2PS_EVENTS_CORE_##EVENT
#define XAIE2PS_EVENT_MEM_MAP(EVENT)		[XAIE_EVENT_##EVENT##_MEM] = XAIE2PS_EVENTS_MEM_##EVENT
#define XAIE2PS_EVENT_PL_MAP(EVENT)		[XAIE_EVENT_##EVENT##_PL] = XAIE2PS_EVENTS_PL_##EVENT
#define XAIE2PS_EVENT_UC_MAP(EVENT)		[XAIE_EVENT_##EVENT##_UC] = XAIE2PS_EVENTS_UC_##EVENT
#define XAIE2PS_EVENT_MEM_TILE_MAP(EVENT)	[XAIE_EVENT_##EVENT##_MEM_TILE] = XAIE2PS_EVENTS_MEM_TILE_##EVENT

static const u16 Aie2PSEventMapping[] =
{
	/* Enum to event number mapping of all events of AIE2PS Core Mod of aie tile */
	XAIE2PS_EVENT_CORE_MAP(NONE),
	XAIE2PS_EVENT_CORE_MAP(TRUE),
	XAIE2PS_EVENT_CORE_MAP(GROUP_0),
	XAIE2PS_EVENT_CORE_MAP(TIMER_SYNC),
	XAIE2PS_EVENT_CORE_MAP(TIMER_VALUE_REACHED),
	XAIE2PS_EVENT_CORE_MAP(PERF_CNT_0),
	XAIE2PS_EVENT_CORE_MAP(PERF_CNT_1),
	XAIE2PS_EVENT_CORE_MAP(PERF_CNT_2),
	XAIE2PS_EVENT_CORE_MAP(PERF_CNT_3),
	XAIE2PS_EVENT_CORE_MAP(COMBO_EVENT_0),
	XAIE2PS_EVENT_CORE_MAP(COMBO_EVENT_1),
	XAIE2PS_EVENT_CORE_MAP(COMBO_EVENT_2),
	XAIE2PS_EVENT_CORE_MAP(COMBO_EVENT_3),
	XAIE2PS_EVENT_CORE_MAP(GROUP_PC_EVENT),
	XAIE2PS_EVENT_CORE_MAP(PC_0),
	XAIE2PS_EVENT_CORE_MAP(PC_1),
	XAIE2PS_EVENT_CORE_MAP(PC_2),
	XAIE2PS_EVENT_CORE_MAP(PC_3),
	XAIE2PS_EVENT_CORE_MAP(PC_RANGE_0_1),
	XAIE2PS_EVENT_CORE_MAP(PC_RANGE_2_3),
	[XAIE_EVENT_GROUP_CORE_STALL_CORE] = XAIE2PS_EVENTS_CORE_GROUP_STALL,
	XAIE2PS_EVENT_CORE_MAP(MEMORY_STALL),
	XAIE2PS_EVENT_CORE_MAP(STREAM_STALL),
	XAIE2PS_EVENT_CORE_MAP(CASCADE_STALL),
	XAIE2PS_EVENT_CORE_MAP(LOCK_STALL),
	XAIE2PS_EVENT_CORE_MAP(DEBUG_HALTED),
	XAIE2PS_EVENT_CORE_MAP(ACTIVE),
	XAIE2PS_EVENT_CORE_MAP(DISABLED),
	XAIE2PS_EVENT_CORE_MAP(ECC_ERROR_STALL),
	XAIE2PS_EVENT_CORE_MAP(ECC_SCRUBBING_STALL),
	[XAIE_EVENT_GROUP_CORE_PROGRAM_FLOW_CORE] = XAIE2PS_EVENTS_CORE_GROUP_PROGRAM_FLOW,
	XAIE2PS_EVENT_CORE_MAP(INSTR_EVENT_0),
	XAIE2PS_EVENT_CORE_MAP(INSTR_EVENT_1),
	XAIE2PS_EVENT_CORE_MAP(INSTR_CALL),
	XAIE2PS_EVENT_CORE_MAP(INSTR_RETURN),
	XAIE2PS_EVENT_CORE_MAP(INSTR_VECTOR),
	XAIE2PS_EVENT_CORE_MAP(INSTR_LOAD),
	XAIE2PS_EVENT_CORE_MAP(INSTR_STORE),
	XAIE2PS_EVENT_CORE_MAP(INSTR_STREAM_GET),
	XAIE2PS_EVENT_CORE_MAP(INSTR_STREAM_PUT),
	XAIE2PS_EVENT_CORE_MAP(INSTR_CASCADE_GET),
	XAIE2PS_EVENT_CORE_MAP(INSTR_CASCADE_PUT),
	XAIE2PS_EVENT_CORE_MAP(INSTR_LOCK_ACQUIRE_REQ),
	XAIE2PS_EVENT_CORE_MAP(INSTR_LOCK_RELEASE_REQ),
	XAIE2PS_EVENT_CORE_MAP(GROUP_ERRORS_0),
	XAIE2PS_EVENT_CORE_MAP(GROUP_ERRORS_1),
	[XAIE_EVENT_SRS_SATURATE_CORE] = XAIE2PS_EVENTS_CORE_SRS_OVERFLOW,
	[XAIE_EVENT_UPS_SATURATE_CORE] = XAIE2PS_EVENTS_CORE_UPS_OVERFLOW,
	XAIE2PS_EVENT_CORE_MAP(FP_INVALID),
	XAIE2PS_EVENT_CORE_MAP(PM_REG_ACCESS_FAILURE),
	XAIE2PS_EVENT_CORE_MAP(STREAM_PKT_PARITY_ERROR),
	XAIE2PS_EVENT_CORE_MAP(CONTROL_PKT_ERROR),
	XAIE2PS_EVENT_CORE_MAP(AXI_MM_SLAVE_ERROR),
	XAIE2PS_EVENT_CORE_MAP(INSTR_DECOMPRSN_ERROR),
	XAIE2PS_EVENT_CORE_MAP(DM_ADDRESS_OUT_OF_RANGE),
	XAIE2PS_EVENT_CORE_MAP(PM_ECC_ERROR_SCRUB_CORRECTED),
	XAIE2PS_EVENT_CORE_MAP(PM_ECC_ERROR_SCRUB_2BIT),
	XAIE2PS_EVENT_CORE_MAP(PM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_CORE_MAP(PM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_CORE_MAP(PM_ADDRESS_OUT_OF_RANGE),
	XAIE2PS_EVENT_CORE_MAP(DM_ACCESS_TO_UNAVAILABLE),
	XAIE2PS_EVENT_CORE_MAP(LOCK_ACCESS_TO_UNAVAILABLE),
	XAIE2PS_EVENT_CORE_MAP(GROUP_STREAM_SWITCH),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_0),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_0),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_0),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_0),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_1),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_1),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_1),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_1),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_2),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_2),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_2),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_2),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_3),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_3),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_3),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_3),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_4),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_4),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_4),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_4),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_5),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_5),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_5),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_5),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_6),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_6),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_6),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_6),
	XAIE2PS_EVENT_CORE_MAP(PORT_IDLE_7),
	XAIE2PS_EVENT_CORE_MAP(PORT_RUNNING_7),
	XAIE2PS_EVENT_CORE_MAP(PORT_STALLED_7),
	XAIE2PS_EVENT_CORE_MAP(PORT_TLAST_7),
	XAIE2PS_EVENT_CORE_MAP(GROUP_BROADCAST),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_0),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_1),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_2),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_3),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_4),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_5),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_6),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_7),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_8),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_9),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_10),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_11),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_12),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_13),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_14),
	XAIE2PS_EVENT_CORE_MAP(BROADCAST_15),
	XAIE2PS_EVENT_CORE_MAP(GROUP_USER_EVENT),
	XAIE2PS_EVENT_CORE_MAP(USER_EVENT_0),
	XAIE2PS_EVENT_CORE_MAP(USER_EVENT_1),
	XAIE2PS_EVENT_CORE_MAP(USER_EVENT_2),
	XAIE2PS_EVENT_CORE_MAP(USER_EVENT_3),
	XAIE2PS_EVENT_CORE_MAP(EDGE_DETECTION_EVENT_0),
	XAIE2PS_EVENT_CORE_MAP(EDGE_DETECTION_EVENT_1),
	XAIE2PS_EVENT_CORE_MAP(FP_HUGE),
	XAIE2PS_EVENT_CORE_MAP(INT_FP_0),
	XAIE2PS_EVENT_CORE_MAP(FP_INF),
	XAIE2PS_EVENT_CORE_MAP(INSTR_WARNING),
	XAIE2PS_EVENT_CORE_MAP(INSTR_ERROR),
	XAIE2PS_EVENT_CORE_MAP(STREAM_SWITCH_PORT_PARITY_ERROR),
	XAIE2PS_EVENT_CORE_MAP(PROCESSOR_BUS_ERROR),
	XAIE2PS_EVENT_CORE_MAP(SPARSITY_OVERFLOW),

	/* Enum to event number mapping of all events of AIE2PS Mem Mod of aie tile */
	XAIE2PS_EVENT_MEM_MAP(NONE),
	XAIE2PS_EVENT_MEM_MAP(TRUE),
	XAIE2PS_EVENT_MEM_MAP(GROUP_0),
	XAIE2PS_EVENT_MEM_MAP(TIMER_SYNC),
	XAIE2PS_EVENT_MEM_MAP(TIMER_VALUE_REACHED),
	XAIE2PS_EVENT_MEM_MAP(PERF_CNT_0),
	XAIE2PS_EVENT_MEM_MAP(PERF_CNT_1),
	XAIE2PS_EVENT_MEM_MAP(COMBO_EVENT_0),
	XAIE2PS_EVENT_MEM_MAP(COMBO_EVENT_1),
	XAIE2PS_EVENT_MEM_MAP(COMBO_EVENT_2),
	XAIE2PS_EVENT_MEM_MAP(COMBO_EVENT_3),
	XAIE2PS_EVENT_MEM_MAP(GROUP_WATCHPOINT),
	XAIE2PS_EVENT_MEM_MAP(WATCHPOINT_0),
	XAIE2PS_EVENT_MEM_MAP(WATCHPOINT_1),
	XAIE2PS_EVENT_MEM_MAP(GROUP_DMA_ACTIVITY),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_FINISHED_BD),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_FINISHED_BD),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_FINISHED_BD),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_FINISHED_BD),
	XAIE2PS_EVENT_MEM_MAP(GROUP_LOCK),
	XAIE2PS_EVENT_MEM_MAP(LOCK_0_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_1_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_2_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_3_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_4_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_5_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_6_REL),
	XAIE2PS_EVENT_MEM_MAP(LOCK_7_REL),
	XAIE2PS_EVENT_MEM_MAP(GROUP_MEMORY_CONFLICT),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_0),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_1),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_2),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_3),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_4),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_5),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_6),
	XAIE2PS_EVENT_MEM_MAP(CONFLICT_DM_BANK_7),
	XAIE2PS_EVENT_MEM_MAP(GROUP_ERRORS),
	XAIE2PS_EVENT_MEM_MAP(DM_ECC_ERROR_SCRUB_CORRECTED),
	XAIE2PS_EVENT_MEM_MAP(DM_ECC_ERROR_SCRUB_2BIT),
	XAIE2PS_EVENT_MEM_MAP(DM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_MEM_MAP(DM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_2),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_3),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_4),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_5),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_6),
	XAIE2PS_EVENT_MEM_MAP(DM_PARITY_ERROR_BANK_7),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_ERROR),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_ERROR),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_ERROR),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_ERROR),
	XAIE2PS_EVENT_MEM_MAP(GROUP_BROADCAST),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_0),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_1),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_2),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_3),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_4),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_5),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_6),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_7),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_8),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_9),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_10),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_11),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_12),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_13),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_14),
	XAIE2PS_EVENT_MEM_MAP(BROADCAST_15),
	XAIE2PS_EVENT_MEM_MAP(GROUP_USER_EVENT),
	XAIE2PS_EVENT_MEM_MAP(USER_EVENT_0),
	XAIE2PS_EVENT_MEM_MAP(USER_EVENT_1),
	XAIE2PS_EVENT_MEM_MAP(USER_EVENT_2),
	XAIE2PS_EVENT_MEM_MAP(USER_EVENT_3),
	XAIE2PS_EVENT_MEM_MAP(EDGE_DETECTION_EVENT_0),
	XAIE2PS_EVENT_MEM_MAP(EDGE_DETECTION_EVENT_1),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_START_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_START_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_START_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_START_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_STALLED_LOCK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_STALLED_LOCK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_STALLED_LOCK),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_STALLED_LOCK),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_STREAM_STARVATION),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_STREAM_STARVATION),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_0_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_MAP(DMA_S2MM_1_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_0_MEMORY_STARVATION),
	XAIE2PS_EVENT_MEM_MAP(DMA_MM2S_1_MEMORY_STARVATION),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL0_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL0_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL0_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL1_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL1_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL1_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL2_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL2_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL2_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL3_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL3_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL3_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL4_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL4_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL4_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL5_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL5_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL5_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL6_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL6_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL6_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL7_ACQ_EQ),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL7_ACQ_GE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_SEL7_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_MAP(LOCK_ERROR),
	XAIE2PS_EVENT_MEM_MAP(DMA_TASK_TOKEN_STALL),

	/* Enum to event number mapping of all events of AIE2PS PL Module */
	XAIE2PS_EVENT_PL_MAP(NONE),
	XAIE2PS_EVENT_PL_MAP(TRUE),
	XAIE2PS_EVENT_PL_MAP(GROUP_0),
	XAIE2PS_EVENT_PL_MAP(TIMER_SYNC),
	XAIE2PS_EVENT_PL_MAP(TIMER_VALUE_REACHED),
	XAIE2PS_EVENT_PL_MAP(PERF_CNT_0),
	XAIE2PS_EVENT_PL_MAP(PERF_CNT_1),
	XAIE2PS_EVENT_PL_MAP(COMBO_EVENT_0),
	XAIE2PS_EVENT_PL_MAP(COMBO_EVENT_1),
	XAIE2PS_EVENT_PL_MAP(COMBO_EVENT_2),
	XAIE2PS_EVENT_PL_MAP(COMBO_EVENT_3),
	XAIE2PS_EVENT_PL_MAP(GROUP_ERRORS),
	[XAIE_EVENT_AXI_MM_SLAVE_TILE_ERROR_PL] = XAIE2PS_EVENTS_PL_AXI_MM_SLAVE_ERROR,
	XAIE2PS_EVENT_PL_MAP(CONTROL_PKT_ERROR),
	XAIE2PS_EVENT_PL_MAP(AXI_MM_DECODE_NSU_ERROR),
	XAIE2PS_EVENT_PL_MAP(AXI_MM_SLAVE_NSU_ERROR),
	XAIE2PS_EVENT_PL_MAP(AXI_MM_UNSUPPORTED_TRAFFIC),
	XAIE2PS_EVENT_PL_MAP(AXI_MM_UNSECURE_ACCESS_IN_SECURE_MODE),
	XAIE2PS_EVENT_PL_MAP(AXI_MM_BYTE_STROBE_ERROR),
	[XAIE_EVENT_GROUP_STREAM_SWITCH_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_GROUP_ERRORS,
	[XAIE_EVENT_PORT_IDLE_0_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_0,
	[XAIE_EVENT_PORT_RUNNING_0_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_0,
	[XAIE_EVENT_PORT_STALLED_0_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_0,
	[XAIE_EVENT_PORT_TLAST_0_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_0,
	[XAIE_EVENT_PORT_IDLE_1_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_1,
	[XAIE_EVENT_PORT_RUNNING_1_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_1,
	[XAIE_EVENT_PORT_STALLED_1_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_1,
	[XAIE_EVENT_PORT_TLAST_1_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_1,
	[XAIE_EVENT_PORT_IDLE_2_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_2,
	[XAIE_EVENT_PORT_RUNNING_2_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_2,
	[XAIE_EVENT_PORT_STALLED_2_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_2,
	[XAIE_EVENT_PORT_TLAST_2_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_2,
	[XAIE_EVENT_PORT_IDLE_3_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_3,
	[XAIE_EVENT_PORT_RUNNING_3_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_3,
	[XAIE_EVENT_PORT_STALLED_3_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_3,
	[XAIE_EVENT_PORT_TLAST_3_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_3,
	[XAIE_EVENT_PORT_IDLE_4_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_4,
	[XAIE_EVENT_PORT_RUNNING_4_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_4,
	[XAIE_EVENT_PORT_STALLED_4_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_4,
	[XAIE_EVENT_PORT_TLAST_4_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_4,
	[XAIE_EVENT_PORT_IDLE_5_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_5,
	[XAIE_EVENT_PORT_RUNNING_5_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_5,
	[XAIE_EVENT_PORT_STALLED_5_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_5,
	[XAIE_EVENT_PORT_TLAST_5_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_5,
	[XAIE_EVENT_PORT_IDLE_6_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_6,
	[XAIE_EVENT_PORT_RUNNING_6_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_6,
	[XAIE_EVENT_PORT_STALLED_6_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_6,
	[XAIE_EVENT_PORT_TLAST_6_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_6,
	[XAIE_EVENT_PORT_IDLE_7_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_IDLE_7,
	[XAIE_EVENT_PORT_RUNNING_7_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_RUNNING_7,
	[XAIE_EVENT_PORT_STALLED_7_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_STALLED_7,
	[XAIE_EVENT_PORT_TLAST_7_PL] = XAIE2PS_EVENTS_PL_STREAM_SWITCH_PORT_TLAST_7,
	XAIE2PS_EVENT_PL_MAP(GROUP_BROADCAST_A),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_0),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_1),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_2),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_3),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_4),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_5),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_6),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_7),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_8),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_9),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_10),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_11),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_12),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_13),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_14),
	XAIE2PS_EVENT_PL_MAP(BROADCAST_A_15),
	XAIE2PS_EVENT_PL_MAP(USER_EVENT_0),
	XAIE2PS_EVENT_PL_MAP(USER_EVENT_1),
	XAIE2PS_EVENT_PL_MAP(EDGE_DETECTION_EVENT_0),
	XAIE2PS_EVENT_PL_MAP(EDGE_DETECTION_EVENT_1),
	XAIE2PS_EVENT_PL_MAP(STREAM_SWITCH_PARITY_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC0_GROUP_DMA_ACTIVITY),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_STREAM_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_STREAM_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_0_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_1_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_0_MEMORY_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_1_MEMORY_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC1_GROUP_DMA_ACTIVITY),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_START_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_FINISHED_BD),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_FINISHED_TASK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_STALLED_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_STREAM_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_STREAM_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_0_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_1_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_0_MEMORY_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_1_MEMORY_STARVATION),
	XAIE2PS_EVENT_PL_MAP(NOC0_GROUP_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_0_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_0_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_0_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_0_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_1_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_1_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_1_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_1_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_2_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_2_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_2_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_2_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_3_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_3_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_3_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_3_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_4_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_4_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_4_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_4_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_5_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_5_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_5_REL),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_5_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_GROUP_LOCK),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_0_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_0_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_0_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_0_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_1_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_1_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_1_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_1_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_2_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_2_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_2_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_2_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_3_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_3_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_3_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_3_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_4_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_4_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_4_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_4_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_5_ACQ_EQ),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_5_ACQ_GE),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_5_REL),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_5_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_S2MM_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_S2MM_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_MM2S_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_MM2S_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC0_LOCK_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC1_LOCK_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC0_TASK_TOKEN_STALL),
	XAIE2PS_EVENT_PL_MAP(NOC1_TASK_TOKEN_STALL),
	XAIE2PS_EVENT_PL_MAP(NOC0_DMA_HW_ERROR),
	XAIE2PS_EVENT_PL_MAP(NOC1_DMA_HW_ERROR),
	XAIE2PS_EVENT_UC_MAP(DMA_GROUP_ACTIVITY),
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_START_TASK),
	[XAIE_EVENT_DMA_MM2DM_START_TASK_UC] = XAIE2PS_EVENTS_UC_DMA_DM2DM_START_TASK,
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_FINISHED_BD),
	[XAIE_EVENT_DMA_MM2DM_FINISHED_BD_UC] = XAIE2PS_EVENTS_UC_DMA_DM2DM_FINISHED_BD,
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_FINISHED_TASK),
	[XAIE_EVENT_DMA_MM2DM_FINISHED_TASK_UC] = XAIE2PS_EVENTS_UC_DMA_DM2DM_FINISHED_TASK,
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_LOCAL_MEMORY_STARVATION),
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_REMOTE_MEMORY_BACKPRESSURE),
	[XAIE_EVENT_DMA_MM2DM_LOCAL_MEMORY_BACKPRESSURE_UC] = XAIE2PS_EVENTS_UC_DMA_DM2DM_LOCAL_MEMORY_STARVATION,
	[XAIE_EVENT_DMA_MM2DM_REMOTE_MEMORY_STARVATION_UC] = XAIE2PS_EVENTS_UC_DMA_DM2DM_REMOTE_MEMORY_BACKPRESSURE,
	XAIE2PS_EVENT_UC_MAP(GROUP_ERRORS),
	XAIE2PS_EVENT_UC_MAP(AXI_MM_CORE_MASTER_DECODE_ERROR),
	XAIE2PS_EVENT_UC_MAP(AXI_MM_DMA_MASTER_DECODE_ERROR),
	XAIE2PS_EVENT_UC_MAP(AXI_MM_CORE_MASTER_SLAVE_ERROR),
	XAIE2PS_EVENT_UC_MAP(AXI_MM_DMA_MASTER_SLAVE_ERROR),
	XAIE2PS_EVENT_UC_MAP(DMA_DM2MM_ERROR),
	XAIE2PS_EVENT_UC_MAP(DMA_MM2DM_ERROR),
	XAIE2PS_EVENT_UC_MAP(PM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_UC_MAP(PM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_UC_MAP(PRIVATE_DM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_UC_MAP(PRIVATE_DM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_UC_MAP(SHARED_DM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_UC_MAP(SHARED_DM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_UC_MAP(CORE_STRAMS_GROUP_ERRORS),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_MASTER_IDLE),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_MASTER_RUNNING),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_MASTER_STALLED),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_MASTER_TLAST),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_SLAVE_IDLE),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_SLAVE_RUNNING),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_SLAVE_STALLED),
	XAIE2PS_EVENT_UC_MAP(CORE_AXIS_SLAVE_TLAST),
	XAIE2PS_EVENT_UC_MAP(CORE_PROGRAM_FLOW_GROUP_ERRORS),
	XAIE2PS_EVENT_UC_MAP(CORE_SLEEP),
	XAIE2PS_EVENT_UC_MAP(CORE_INTERRUPT),
	XAIE2PS_EVENT_UC_MAP(CORE_DEBUG_SYS_RESET),
	XAIE2PS_EVENT_UC_MAP(CORE_DEBUG_WAKEUP),
	XAIE2PS_EVENT_UC_MAP(CORE_TIMER1_INTERRUPT),
	XAIE2PS_EVENT_UC_MAP(CORE_TIMER2_INTERRUPT),
	XAIE2PS_EVENT_UC_MAP(CORE_TIMER3_INTERRUPT),
	XAIE2PS_EVENT_UC_MAP(CORE_TIMER4_INTERRUPT),
	XAIE2PS_EVENT_UC_MAP(CORE_REG_WRITE),
	XAIE2PS_EVENT_UC_MAP(CORE_EXCEPTION_TAKEN),
	XAIE2PS_EVENT_UC_MAP(CORE_JUMP_TAKEN),
	XAIE2PS_EVENT_UC_MAP(CORE_JUMP_HIT),
	XAIE2PS_EVENT_UC_MAP(CORE_DATA_READ),
	XAIE2PS_EVENT_UC_MAP(CORE_DATA_WRITE),
	XAIE2PS_EVENT_UC_MAP(CORE_PIPLINE_HALTED_DEBUG),
	XAIE2PS_EVENT_UC_MAP(CORE_STREAM_GET),
	XAIE2PS_EVENT_UC_MAP(CORE_STREAM_PUT),

	/* Enum to event number mapping of all events of AIE2PS Mem Tile Module */
	XAIE2PS_EVENT_MEM_TILE_MAP(NONE),
	XAIE2PS_EVENT_MEM_TILE_MAP(TRUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(TIMER_SYNC),
	XAIE2PS_EVENT_MEM_TILE_MAP(TIMER_VALUE_REACHED),
	XAIE2PS_EVENT_MEM_TILE_MAP(PERF_CNT0_EVENT),
	XAIE2PS_EVENT_MEM_TILE_MAP(PERF_CNT1_EVENT),
	XAIE2PS_EVENT_MEM_TILE_MAP(PERF_CNT2_EVENT),
	XAIE2PS_EVENT_MEM_TILE_MAP(PERF_CNT3_EVENT),
	XAIE2PS_EVENT_MEM_TILE_MAP(COMBO_EVENT_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(COMBO_EVENT_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(COMBO_EVENT_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(COMBO_EVENT_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(EDGE_DETECTION_EVENT_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(EDGE_DETECTION_EVENT_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_WATCHPOINT),
	XAIE2PS_EVENT_MEM_TILE_MAP(WATCHPOINT_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(WATCHPOINT_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(WATCHPOINT_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(WATCHPOINT_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_DMA_ACTIVITY),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL0_START_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL1_START_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL0_START_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL1_START_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL0_FINISHED_BD),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL1_FINISHED_BD),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL0_FINISHED_BD),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL1_FINISHED_BD),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL0_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL1_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL0_FINISHED_TASK),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL1_FINISHED_TASK),
	[XAIE_EVENT_DMA_S2MM_SEL0_STALLED_LOCK_ACQUIRE_MEM_TILE] = XAIE2PS_EVENTS_MEM_TILE_DMA_S2MM_SEL0_STALLED_LOCK,
	[XAIE_EVENT_DMA_S2MM_SEL1_STALLED_LOCK_ACQUIRE_MEM_TILE] = XAIE2PS_EVENTS_MEM_TILE_DMA_S2MM_SEL1_STALLED_LOCK,
	[XAIE_EVENT_DMA_MM2S_SEL0_STALLED_LOCK_ACQUIRE_MEM_TILE] = XAIE2PS_EVENTS_MEM_TILE_DMA_MM2S_SEL0_STALLED_LOCK,
	[XAIE_EVENT_DMA_MM2S_SEL1_STALLED_LOCK_ACQUIRE_MEM_TILE] = XAIE2PS_EVENTS_MEM_TILE_DMA_MM2S_SEL1_STALLED_LOCK,
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL0_STREAM_STARVATION),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL1_STREAM_STARVATION),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL0_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL1_STREAM_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL0_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_SEL1_MEMORY_BACKPRESSURE),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL0_MEMORY_STARVATION),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_SEL1_MEMORY_STARVATION),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_LOCK),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL0_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL0_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL0_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL0_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL1_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL1_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL1_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL1_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL2_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL2_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL2_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL2_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL3_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL3_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL3_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL3_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL4_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL4_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL4_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL4_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL5_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL5_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL5_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL5_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL6_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL6_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL6_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL6_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL7_ACQ_EQ),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL7_ACQ_GE),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL7_REL),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_SEL7_EQUAL_TO_VALUE),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_STREAM_SWITCH),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_IDLE_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_RUNNING_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_STALLED_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(PORT_TLAST_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_MEMORY_CONFLICT),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_8),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_9),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_10),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_11),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_12),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_13),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_14),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONFLICT_DM_BANK_15),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_ERRORS),
	XAIE2PS_EVENT_MEM_TILE_MAP(DM_ECC_ERROR_SCRUB_CORRECTED),
	XAIE2PS_EVENT_MEM_TILE_MAP(DM_ECC_ERROR_SCRUB_2BIT),
	XAIE2PS_EVENT_MEM_TILE_MAP(DM_ECC_ERROR_1BIT),
	XAIE2PS_EVENT_MEM_TILE_MAP(DM_ECC_ERROR_2BIT),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_S2MM_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_MM2S_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(STREAM_SWITCH_PARITY_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(STREAM_PKT_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(CONTROL_PKT_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(AXI_MM_SLAVE_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(LOCK_ERROR),
	XAIE2PS_EVENT_MEM_TILE_MAP(DMA_TASK_TOKEN_STALL),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_BROADCAST),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_1),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_2),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_3),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_4),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_5),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_6),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_7),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_8),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_9),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_10),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_11),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_12),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_13),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_14),
	XAIE2PS_EVENT_MEM_TILE_MAP(BROADCAST_15),
	XAIE2PS_EVENT_MEM_TILE_MAP(GROUP_USER_EVENT),
	XAIE2PS_EVENT_MEM_TILE_MAP(USER_EVENT_0),
	XAIE2PS_EVENT_MEM_TILE_MAP(USER_EVENT_1),

	[XAIE_EVENT_MAX] = XAIE_EVENT_INVALID,
};

static const u16 Aie2PSNocModEventMapping[] =
{
...
static const XAie_EventGroup Aie2PSPlGroupEvent[] =
{
	...
	{
		.GroupEvent = XAIE_EVENT_NOC0_GROUP_DMA_ACTIVITY_PL,
		.GroupOff = 1U,
	...
	{
		.GroupEvent = XAIE_EVENT_NOC1_GROUP_DMA_ACTIVITY_PL,
		.GroupOff = 2U,
	...
	{
		.GroupEvent = XAIE_EVENT_NOC0_GROUP_LOCK_PL,
		.GroupOff = 3U,
	...
	{
		.GroupEvent = XAIE_EVENT_NOC1_GROUP_LOCK_PL,
		.GroupOff = 4U,
	...
	},
	{
		...
		.GroupOff = 5U,
		.GroupMask = XAIE2PSGBL_PL_MODULE_EVENT_GROUP_ERRORS_ENABLE_MASK,
		.ResetValue = XAIE2PSGBL_PL_MODULE_EVENT_GROUP_ERRORS_ENABLE_MASK,
	},
	{
...
{
	{
		.XAie_EventNumber = Aie2PSEventMapping,
		.NumEventReg = 4U,
		...
		.GenEvent = {XAIE2PSGBL_MEMORY_MODULE_EVENT_GENERATE_EVENT_LSB,
			     XAIE2PSGBL_MEMORY_MODULE_EVENT_GENERATE_EVENT_MASK},
		...
		.EdgeDetectEvent = {XAIE2PSGBL_MEMORY_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_LSB,
				    XAIE2PSGBL_MEMORY_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_MASK},
		.EdgeDetectTrigger = {XAIE2PSGBL_MEMORY_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_LSB,
				      XAIE2PSGBL_MEMORY_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_FALLING_MASK |
				      XAIE2PSGBL_MEMORY_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_MASK},
	...
	},
	{
		...
		.GenEvent = {XAIE2PSGBL_CORE_MODULE_EVENT_GENERATE_EVENT_LSB,
			     XAIE2PSGBL_CORE_MODULE_EVENT_GENERATE_EVENT_MASK},
		...
		.EdgeDetectEvent = {XAIE2PSGBL_CORE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_LSB,
				    XAIE2PSGBL_CORE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_MASK},
		.EdgeDetectTrigger = {XAIE2PSGBL_CORE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_LSB,
				      XAIE2PSGBL_CORE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_FALLING_MASK |
				      XAIE2PSGBL_CORE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_MASK},
...
static const XAie_EvntMod Aie2PSNocEvntMod =
{
	...
	.GenEvent = {XAIE2PSGBL_PL_MODULE_EVENT_GENERATE_EVENT_LSB,
		     XAIE2PSGBL_PL_MODULE_EVENT_GENERATE_EVENT_MASK},
	...
	.EdgeDetectEvent = {XAIE2PSGBL_PL_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_LSB,
			    XAIE2PSGBL_PL_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_MASK},
	.EdgeDetectTrigger = {XAIE2PSGBL_PL_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_LSB,
			      XAIE2PSGBL_PL_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_FALLING_MASK |
			      XAIE2PSGBL_PL_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_MASK},
...
static const XAie_EvntMod Aie2PSMemTileEvntMod =
{
	...
	.GenEvent = {XAIE2PSGBL_MEM_TILE_MODULE_EVENT_GENERATE_EVENT_LSB,
		     XAIE2PSGBL_MEM_TILE_MODULE_EVENT_GENERATE_EVENT_MASK},
	...
	.EdgeDetectEvent = {XAIE2PSGBL_MEM_TILE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_LSB,
			    XAIE2PSGBL_MEM_TILE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_EVENT_0_MASK},
	.EdgeDetectTrigger = {XAIE2PSGBL_MEM_TILE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_LSB,
			      XAIE2PSGBL_MEM_TILE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_FALLING_MASK |
			      XAIE2PSGBL_MEM_TILE_MODULE_EDGE_DETECTION_EVENT_CONTROL_EDGE_DETECTION_0_TRIGGER_RISING_MASK},
...
{
	.BaseMaskRegOff = XAIE2PSGBL_PL_MODULE_INTERRUPT_CONTROLLER_1ST_LEVEL_MASK_A,
	...
	.BaseStatusRegOff = XAIE2PSGBL_PL_MODULE_INTERRUPT_CONTROLLER_1ST_LEVEL_STATUS_A,
...
{
	.MaskRegOff = XAIE2PSGBL_NOC_MODULE_INTERRUPT_CONTROLLER_2ND_LEVEL_MASK,
	...
	.StatusRegOff = XAIE2PSGBL_NOC_MODULE_INTERRUPT_CONTROLLER_2ND_LEVEL_STATUS,
...
/*
 * Data structure to configure axi-mm tile control for
 * XAIEGBL_TILE_TYPE_SHIMPL/NOC tile types.
 */
static const XAie_AxiMMTileCtrlMod Aie2PSShimAxiMMTileCtrlMod =
{
	.TileCtrlAxiMMRegOff = XAIE2PSGBL_PL_MODULE_TILE_CONTROL_AXI_MM,
	.AxiMMIsolateEast = {XAIE2PSGBL_PL_MODULE_TILE_CONTROL_AXI_MM_ISOLATE_FROM_EAST_LSB, XAIE2PSGBL_PL_MODULE_TILE_CONTROL_AXI_MM_ISOLATE_FROM_EAST_MASK},
	.AxiMMIsolateWest = {XAIE2PSGBL_PL_MODULE_TILE_CONTROL_AXI_MM_ISOLATE_FROM_WEST_LSB, XAIE2PSGBL_PL_MODULE_TILE_CONTROL_AXI_MM_ISOLATE_FROM_WEST_MASK},
};
...
static const XAie_MemCtrlMod Aie2PSMemTileMemCtrlMod =
{
	...
	#define AIEMLSHIMAXIMMTILECTRLMOD &Aie2PSShimAxiMMTileCtrlMod
	...
	#define AIEMLSHIMAXIMMTILECTRLMOD NULL
...
XAie_TileMod Aie2PSMod[] =
{
	...
	},
	{
		...
		.AxiMMTileCtrlMod = AIEMLSHIMAXIMMTILECTRLMOD,
		.MemCtrlMod = NULL,
		.UcMod = AIE2PSUCMOD,
	},
	{
